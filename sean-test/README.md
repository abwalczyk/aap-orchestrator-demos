# Disk Utilization & Remediation Workflow (sean-test sandbox)

**Sean-test copy** — identical playbooks and AO workflow to [`disk-utilization/`](../disk-utilization/). Used to experiment with custom Mermaid diagram assets on the demo marketplace.
